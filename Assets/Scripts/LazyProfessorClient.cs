...
public class LazyProfessorClient : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.C))
            SendMessageToHost(ClientToServerTransferSignifiers.CreateAccount + ",101249099,hard");
        else if (Input.GetKeyDown(KeyCode.L))
            SendMessageToHost(ClientToServerTransferSignifiers.Login + ",101249099,hard");
